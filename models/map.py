...
class Map:
    ...
    def view_map(self, window):
        ...
        wall_img = pygame.transform.scale\
                    (wall_img, (constants.SPRITES_SIZE, constants.SPRITES_SIZE))
        ...
        paths_img = pygame.transform.scale\
                (paths_img, (constants.SPRITES_SIZE, constants.SPRITES_SIZE))
        ...
        start_img = pygame.transform.scale\
                    (start_img, (constants.SPRITES_SIZE, constants.SPRITES_SIZE))
